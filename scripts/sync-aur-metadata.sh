...
pkgbase = openlinear-bin
	...
	options = !strip
	options = !debug
	source = openlinear-${VERSION}-x86_64-linux.tar.gz::https://github.com/kaizen403/openlinear/releases/download/v${VERSION}/openlinear-${VERSION}-x86_64-linux.tar.gz
