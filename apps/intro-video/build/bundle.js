...
// EXTERNAL MODULE: ../../node_modules/.pnpm/remotion@4.0.421_react-dom@18.3.0_react@18.3.0__react@18.3.0/node_modules/remotion/dist/esm/index.mjs
var esm = __webpack_require__(3788);
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.3.0/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(5402);
;// ./src/scenes/GlowReveal.tsx



const GlowReveal = () => {
  const frame = (0,esm.useCurrentFrame)();
  const glowIntensity = (0,esm.interpolate)(frame, [0, 60], [0, 1], {
...
;// ./src/scenes/TitleReveal.tsx



const TitleReveal = ({ text = "OpenLinear" }) => {
  const frame = (0,esm.useCurrentFrame)();
  const containerOpacity = (0,esm.interpolate)(frame, [0, 15], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: letters.map((letter, index) => {
              ...
              const opacity = (0,esm.interpolate)(letterFrame, [0, 20], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              });
              const scale = (0,esm.spring)({
              ...
              const translateY = (0,esm.interpolate)(letterFrame, [0, 25], [30, 0], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
                easing: esm.Easing.out(esm.Easing.cubic)
              });
              const glowIntensity = (0,esm.interpolate)(letterFrame, [10, 40], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              });
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              width: (0,esm.interpolate)(frame, [30, 60], [0, 300], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              }),
              height: 3,
...
;// ./src/scenes/TaglineReveal.tsx



const TaglineReveal = ({ text = "AI-Powered Code Execution" }) => {
  const frame = (0,esm.useCurrentFrame)();
  const startFrame = 90;
  const opacity = (0,esm.interpolate)(frame, [startFrame, startFrame + 20], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  const glowIntensity = (0,esm.interpolate)(frame, [startFrame + 10, startFrame + 40], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: words.map((word, wordIndex) => {
              ...
              const wordOpacity = (0,esm.interpolate)(wordFrame, [0, 15], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp"
              });
              const wordTranslateY = (0,esm.interpolate)(wordFrame, [0, 20], [15, 0], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
...
const FadeOut = () => {
  ...
  const overlayOpacity = (0,esm.interpolate)(frame, [fadeStartFrame, fadeStartFrame + 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: esm.Easing.inOut(esm.Easing.quad)
  });
  const scale = (0,esm.interpolate)(frame, [fadeStartFrame, fadeStartFrame + 60], [1, 1.1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            opacity: (0,esm.interpolate)(frame, [fadeStartFrame, fadeStartFrame + 30], [0, 0.5], {
              extrapolateLeft: "clamp",
              extrapolateRight: "clamp"
            }),
            filter: "blur(60px)"
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.3.0/node_modules/react/index.js
var react = __webpack_require__(9554);
...
const Particles = () => {
  ...
  const particles = (0,react.useMemo)(() => {
    ...
    return Array.from({ length: count }, (_, i) => ({
      id: i,
      x: (0,esm.random)(`particle-x-${i}`) * 1920,
      y: (0,esm.random)(`particle-y-${i}`) * 1080,
      size: (0,esm.random)(`particle-size-${i}`) * 3 + 1,
      delay: (0,esm.random)(`particle-delay-${i}`) * 60,
      duration: (0,esm.random)(`particle-duration-${i}`) * 120 + 60
    }));
  }, []);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
...
const Intro = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowReveal, {}),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(Particles, {}),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(TitleReveal, {}),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(TaglineReveal, {}),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeOut, {})
      ]
    }
  );
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9554);
...
var m = __webpack_require__(1834);
if (true) {
...
if (true) {
  ...
  checkDCE();
  module.exports = __webpack_require__(8190);
} else // removed by dead control flow
{}
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(9554),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
if (true) {
  module.exports = __webpack_require__(4973);
} else // removed by dead control flow
{}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9554);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2259);
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3788);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1343);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5402);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(318), __webpack_require__.e(654)]).then(__webpack_require__.bind(__webpack_require__, 9318)).then(({ StudioInternals }) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9554);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5402);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1834);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "intro-video:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkintro_video"] = self["webpackChunkintro_video"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__(6456);
/******/ 	
/******/ })()
;
