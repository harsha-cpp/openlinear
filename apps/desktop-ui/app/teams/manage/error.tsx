...
export default function SectionError({
  ...
  useEffect(() => {
    toast.error("Couldn't load Manage teams", {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-8">
      <div className="w-full max-w-md rounded-2xl border border-border/60 bg-card p-7 shadow-sm">
