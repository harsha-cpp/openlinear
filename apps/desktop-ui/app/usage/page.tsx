...
function ChartTooltip({ active, payload }: { active?: boolean; payload?: ChartTooltipPayload[] }) {
  ...
  return (
    <div className="bg-linear-bg-secondary border border-linear-border rounded-md px-3 py-2 shadow-xl">
...
function StatCard({
  ...
  return (
    <div className="bg-linear-bg-secondary border border-linear-border rounded-lg p-4">
      ...
      <div className="flex-1 overflow-y-auto bg-[#111111]">
        {loading && !summary ? (
          ...
          <div className="p-4 sm:p-6 space-y-6 max-w-7xl mx-auto">
            ...
            <section className="bg-linear-bg-secondary border border-linear-border rounded-lg p-4">
            ...
            <section className="bg-linear-bg-secondary border border-linear-border rounded-lg overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-linear-border">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs text-linear-text-secondary hover:text-linear-text hover:bg-linear-bg-tertiary transition-colors border border-linear-border"
                  >
                  ...
                  {sortMenuOpen && (
                    <div className="absolute right-0 top-full mt-1 w-40 bg-linear-bg-secondary border border-linear-border rounded-md shadow-xl z-10 p-1">
