...
OpenLinear's desktop app is built with Tauri 2 (Rust shell) and Next.js (webview UI). It bundles a local sidecar API that handles execution, database access, and real-time events.
