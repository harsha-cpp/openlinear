...
OpenLinear authenticates with GitHub entirely on your local machine. No hosted callback server is involved — tokens are stored locally and never leave your machine.
