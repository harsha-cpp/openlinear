...
The `openlinear` npm package serves two purposes: a CLI launcher for the desktop app and a TypeScript utility library for execution metadata, payload validation, and feature flags.
